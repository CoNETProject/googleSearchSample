...
export const GoogleSearchNext = ( link, __CallBack) => {
...
export const openHtmlPage = ( sideUrl: string, width = 800, height = 1200, uuid: string, __CallBack ) => {
    let _callback = false
...
export const GoogleImageSearch = ( imageFileName: string, __CallBack ) => {
...
export const GoogleNewsSearch = ( newsUrl, __CallBack ) => {
    return GoogleSearchNext ( newsUrl, __CallBack )
}

export const GoogleSearchFunV2 = ( searchWord, __CallBack ) => {
